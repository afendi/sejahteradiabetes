    ...
    <ul class="flex">
      ...
      <li class="mr-3">
        <span
          ...
          Langkah Penjagaan Gigi Palsu
        </span>
      </li>
    </ul>
  </div>

  <div class="flex min-w-full justify-center" style="background-color:#9294ca">
    <img src="p4/part1.png" class="object-center" alt="part1" />
  </div>

  <div class="grid grid-cols-1 md:grid-cols-3" style="background-color:#9294ca">

    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">

          <img src="p4/part1a.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part1b.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part1c.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part2.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part3.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part4.png" class="w-auto object-center" alt="part1" />
        </div>
    ...
    <div class="max-w-sm  overflow-hidden m-0">
      <div class="flex flex-col min-h-full">
        <div class="flex justify-center">
          ...
          <img src="p4/part5.png" class="w-auto object-center" alt="part1" />
        </div>
